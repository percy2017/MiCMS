...
export function LogoPicker({ logoId, logoUrl, onChange }: LogoPickerProps) {
    ...
    const loadMedia = useCallback(async (): Promise<void> => {
        setLoading(true);
        try {
            const url = '/admin/media?type=image&per_page=60';
            ...
            console.error('LogoPicker: failed to load media', err);
            setItems([]);
        } finally {
            setLoading(false);
        }
                            ...
                            <div className="max-h-[400px] overflow-y-auto">
                                {loading ? (
                                    ...
                                    <div className="py-12 text-center text-sm text-muted-foreground">
                                        No hay imágenes disponibles. Cambia a la
