...
import scheduleRoutes, { update } from '@/routes/admin/schedule';
...
export default function ScheduleEdit({ task, commands }: { task: TaskData; commands: Command[] }) {
    const { data, setData, patch, processing, errors } = useForm({
        ...
        on_one_server: task.on_one_server,
        run_in_maintenance: task.run_in_maintenance,
        active: task.active,
    });

    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        patch(update.url({ task: task.id }));
    }
...
ScheduleEdit.layout = {
    breadcrumbs: [
        ...
        { title: 'Editar Tarea', href: scheduleRoutes.create() },
    ],
};