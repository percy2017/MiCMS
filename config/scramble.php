...
use App\Http\Middleware\EnsureUserCanViewApiDocs;
...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'REST API del CMS. Autenticación vía sesión web (cookie). Endpoints bajo `/api/v1`.',
    ],
    ...
    'middleware' => [
        'web',
        'auth',
        EnsureUserCanViewApiDocs::class,
    ],
